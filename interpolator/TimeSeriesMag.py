...
import numpy as num
class TimeSeriesMag:
    def __init__(self, time, values, valerrp, valerrm, filterstr, calcspline=True, period=-1.0, ra=None, dec=None, m5=None):
        ''' Construct TimeSeriesMag object from time sampling time, magnitude values values
            ...
            valerr -- list of error values associated with each time point
        ...
        '''
        self.setData(time, values, valerrp, valerrm, m5, filterstr, calcspline, period, ra, dec)
        #Set data for the object.
    def setData(self, time, values, valerrp, valerrm, m5, filterstr, calcspline, period, ra, dec):
